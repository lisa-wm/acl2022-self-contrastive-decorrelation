...
from scd.models import RobertaForCL, BertForCL
from scd.trainers import CLTrainer
...
class ModelArguments:
    ...
    hidden_dropout_prob: float = field(
        default=0.1,
        metadata={"help": "Hidden dropout rate, e.g. 0.1 = 10%"}
    )
    hidden_dropout_prob_noise: float = field(
        default=0.15,
        metadata={"help": "Hidden dropout rate for noisy embedding, e.g. 0.1 = 10%"}
    )
    attention_probs_dropout_prob: float = field(
        default=None,
        metadata={"help": "Attention dropout rate, e.g. 0.1 = 10%"}
    )
    attention_probs_dropout_prob_noise: float = field(
        default=None,
        metadata={"help": "Attention dropout rate for noisy embedding, e.g. 0.1 = 10%"}
    )
    task_lambda: float = field(
        default=0.011,
        metadata={"help": "Decorrlation coefficient"}
    )
    task_alpha: float = field(
        default=1.0,
        metadata={"help": "Self-contrast loss weight"}
    )
    task_beta: float = field(
        default=1.0,
        metadata={"help": "Decorrelation loss weight"}
    )
    embedding_dim: int = field(
        default=768,
        metadata={
            "help": "Dimensionality of embedding of language model"
        },
    )
    projector: str = field(
    ...
    lambda1_unc: float = field(
        default=1.0,
        metadata={
            "help": "Coefficient for uncertainty regularizer"
        },
    )
    lambda2_unc: float = field(
        default=10.0,
        metadata={
